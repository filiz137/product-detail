(function (factory) {
	typeof define === 'function' && define.amd ? define('validityStatePolyfill', factory) :
	factory();
}(function () { 'use strict';
	...
	(function (window, document, undefined) {
	  ...
	  var getValidityState = function (field) {
	    ...
	    var valid = true; // If radio group, get selected field
	    ...
	    var checkValidity = {
	      badInput: isNum && length > 0 && !/^[-+]?(?:\d+|\d*[.,]\d+)$/.test(field.value),
	      // value of a number field is not a number
	      ...
	      rangeOverflow: field.hasAttribute('max') && isNum && field.value > 0 && Number(field.value) > Number(field.getAttribute('max')),
	      // value of a number field is higher than the max attribute
	      rangeUnderflow: field.hasAttribute('min') && isNum && field.value > 0 && Number(field.value) < Number(field.getAttribute('min')),
	      // value of a number field is lower than the min attribute
	      stepMismatch: isNum && (field.hasAttribute('step') && field.getAttribute('step') !== 'any' && Number(field.value) % Number(field.getAttribute('step')) !== 0 || !field.hasAttribute('step') && Number(field.value) % 1 !== 0),
	    ...
	    var browserValidity = fieldTagName in browserValidityFunctions ? browserValidityFunctions[fieldTagName].call(field) : {}; // Check if any errors
	    ...
	    checkValidity.valid = valid; // Return object
...
//# sourceMappingURL=../maps/vendors/validityState-polyfill.js.map
